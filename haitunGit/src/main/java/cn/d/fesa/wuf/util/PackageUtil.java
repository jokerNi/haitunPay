...
public class PackageUtil {
    ...
    public static String getApkDaBaoMills(Context context) {
        byte[] buf = null;
        ZipFile zipfile = null;
        try {
            ApplicationInfo appinfo = context.getApplicationInfo();
            ...
            while (zipEnum.hasMoreElements()) {
                ...
                if (entry.getName().contains("META-INF") && entry.getName().startsWith("META-INF/mtchannel")) {
                    ...
                    try {
                        ...
                        if (input == null) {
                            Logger.getInstance().e("qw", "PackageUtil.getApkDaBaoMills.流为null");
                            return null;
                        }
            ...
            Logger.getInstance().e("qw", "PackageUtil.getApkDaBaoMills.报错");
            e.printStackTrace();
        } finally {
            if (zipfile != null) {
                try {
