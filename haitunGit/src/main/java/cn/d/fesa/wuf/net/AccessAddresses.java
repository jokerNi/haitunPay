...
import cn.d.fesa.wuf.util.CreateMD5;
...
public class AccessAddresses {
    ...
    public static String salary1 = "1";
    public static String salary2 = "0.01";
    //信息 更新
    ...
    //CommentActivity请求参数
    public static String comment_Url = "comments.php?pay_Id=" + pay_Id + "&package=" + pack + "&appid=" + app_Id + "&v=" + versionName
            + "&channel=" + channel + "&imei=" + imei + "&md5="
            + CreateMD5.getMd5(imei + channel + imei) + "&id=";
    ...
    public static String update_Url = /*jsonDomain + */"update.php?pay_Id=" + pay_Id + "&package=" + pack + "&appid=" + app_Id + "&v=" + versionName
            ...
            + CreateMD5.getMd5(imei + channel + imei) + "&azsj=" + azsj;
    //
    public static String free_Url = "free.php?pay_Id=" + pay_Id + "&package=" + pack + "&appid=" + app_Id + "&imei=" + imei + "&v=" + versionName
            + "&channel=" + channel;
    public static String living_Url = "living.php?pay_Id=" + pay_Id + "&package=" + pack + "&appid=" + app_Id + "&page=";
    public static String confidential_Url = "confidential.php?pay_Id=" + pay_Id + "&package=" + pack + "&v=" + versionName + "&channel=" + channel + "&imei=" + imei + "&appid=" + app_Id + "&page=";
    public static String bbs_Url = "bbs.php?pay_Id=" + pay_Id + "&package=" + pack + "&appid=" + app_Id + "&page=";

    public static String fragment_a_Url = "buyVideo.php?pay_Id=" + pay_Id + "&package=" + pack + "&v=" + versionName
            + "&channel=" + channel + "&imei=" + imei + "&appid=" + app_Id + "&page=";
    public static String fragment_b_Url = "buyPerson.php?pay_Id=" + pay_Id + "&package="
            + pack + "&v=" + versionName + "&channel=" + channel + "&imei=" + imei + "&appid=" + app_Id + "&page=";

    public static String dianjiTongJiUrl = "movieCount.php?pay_Id=" + pay_Id + "&package=" + pack + "&appid=" + app_Id + "&v=" + versionName
            + "&channel=" + channel + "&imei=" + imei + "&md5="
            + CreateMD5.getMd5(imei + channel + imei) + "&azsj=" + azsj;
    //GOLD VIP
    public static String gold_Url = "vipLevel.php?level=1" + "&pay_Id=" + pay_Id + "&package=" + pack + "&imei=" + imei + "&v=" + versionName + "&appid=" + app_Id + "&page=";

    //DIAMOND VIP
    public static String diamond_Url = "vipLevel.php?level=3" + "&pay_Id=" + pay_Id + "&package=" + pack + "&imei=" + imei + "&v=" + versionName + "&appid=" + app_Id + "&page=";

    //BLACK VIP
    public static String blackdiamond_Url = "vipLevel.php?level=5" + "&pay_Id=" + pay_Id + "&package=" + pack + "&imei=" + imei + "&v=" + versionName + "&appid=" + app_Id + "&page=";

    //ROYAL VIP
    public static String royal_Url = "vipLevel.php?level=7" + "&pay_Id=" + pay_Id + "&package=" + pack + "&imei=" + imei + "&v=" + versionName + "&appid=" + app_Id + "&page=";

    //EXTREME VIP
    public static String extreme_Url = "vipLevel.php?level=9" + "&pay_Id=" + pay_Id + "&package=" + pack + "&imei=" + imei + "&v=" + versionName + "&appid=" + app_Id + "&page=";

    //LIFELONG VIP
    public static String lifelong_Url = "vipLevel.php?level=11" + "&pay_Id=" + pay_Id + "&package=" + pack + "&imei=" + imei + "&v=" + versionName + "&appid=" + app_Id + "&page=";

    //ALLTOP VIP
    public static String allVideos_Url = "allVideos.php?pay_Id=" + pay_Id + "&package=" + pack + "&imei=" + imei + "&v=" + versionName + "&appid=" + app_Id + "&page=";
}
