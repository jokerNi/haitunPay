...
import cn.d.fesa.wuf.act.CommentActivity;
import cn.d.fesa.wuf.act.HaveBeenPayedActivity;
import cn.d.fesa.wuf.act.NewPlayActivity;
import cn.d.fesa.wuf.act.PrivateVideoUserActivity;
...
import cn.d.fesa.wuf.pay.VideoDiaLogActvivity;
...
public class UIUtils {
    ...
    private static void shiKanVideo(String playurl, String name, String shikan, String videoId) {
        try {
            Intent intent = new Intent("cn.d.fesa.wuf");
