...
import cn.d.fesa.wuf.adapter.MainPageAdapter;
...
import cn.d.fesa.wuf.exit.ExitActivity;
import cn.d.fesa.wuf.net.AccessAddresses;
import cn.d.fesa.wuf.net.ImageLoader;
import cn.d.fesa.wuf.page.CommonMemberPage;
import cn.d.fesa.wuf.page.FreeMemberPage;
import cn.d.fesa.wuf.page.MinePage;
import cn.d.fesa.wuf.page.PrivateVideoMemberPage;
import cn.d.fesa.wuf.ui.CustomViewPager;
import cn.d.fesa.wuf.ui.view.LazyViewPager;
...
import cn.d.fesa.wuf.util.UpdateManager;
            ...
            try {
                OkHttpUtils.get().url(fisrtInfoUrl).build().execute(new StringCallback() {
                    ...
                    public void onResponse(String response) {
                        ...
                        SharedPreferencesUtils.saveString(UIUtils.getContext(), "installDate", UIUtils.getInstallDate());
                    }
                });
            } catch (Exception e) {
                e.printStackTrace();
