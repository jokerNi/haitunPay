...
import cn.d.exds.ase.adapter.MainPageAdapter;
import cn.d.exds.ase.adapter.PrivateVideoPageAdapter;
import cn.d.exds.ase.base.BaseActivity;
import cn.d.exds.ase.base.BaseApplication;
import cn.d.exds.ase.base.BasePage;
import cn.d.exds.ase.page.CommonMemberPage;
import cn.d.exds.ase.page.FreeMemberPage2;
import cn.d.exds.ase.page.MinePage;
import cn.d.exds.ase.util.Logger;
import cn.d.exds.ase.util.PassEvent;
import cn.d.exds.ase.exit.ExitActivity;
import cn.d.exds.ase.net.AccessAddresses;
import cn.d.exds.ase.page.FreeMemberPage;
import cn.d.exds.ase.page.PrivateVideoMemberPage;
import cn.d.exds.ase.ui.CustomViewPager;
import cn.d.exds.ase.ui.view.LazyViewPager;
...
import cn.d.exds.ase.util.UpdateManager;
...
public class MainActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        sendStatisticalData();
        try {
            Logger.getInstance().e("qw", "MainActivity.initView.串号= " + PackageUtil.getImei(getApplicationContext()));
        } catch (Exception e) {
            Logger.getInstance().e("qw", "MainActivity.initView." + e.getMessage());
            e.printStackTrace();
        }
