...
import cn.d.sedfr.fhd.act.CommentActivity;
import cn.d.sedfr.fhd.act.HaveBeenPayedActivity;
import cn.d.sedfr.fhd.act.PrivateVideoUserActivity;
import cn.d.sedfr.fhd.base.BaseApplication;
import cn.d.sedfr.fhd.act.MinePageActivity;
import cn.d.sedfr.fhd.bean.Users;
import cn.d.sedfr.fhd.bean.Videos;
import cn.d.sedfr.fhd.pay.DiaLogActvivity;
import cn.d.sedfr.fhd.pay.VideoDiaLogActvivity;
...
public class UIUtils {
    ...
    private static void shiKanVideo(String playurl, String name, String shikan, String videoId) {
        try {
            Intent intent = new Intent("cn.d.sedfr.fhd");
    ...
    public static void gotoComentActivity(String playurl, String name, String type, String id) {
        if (Pass.TRY_PLAY.equals(type)) {
            playVideoTrySee(playurl, name, "true", id);
        } else if (Pass.CAN_PLAY.equals(type)) {
            movie(playurl, name, id);
